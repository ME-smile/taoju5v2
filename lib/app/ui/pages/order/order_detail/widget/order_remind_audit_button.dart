 ...
 * @LastEditTime: 2021-01-10 17:49:28
 */
...
class OrderRemindAuditButton extends GetView<OrderDetailController> {
  const OrderRemindAuditButton({Key key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Visibility(
      child: OutlineButton(onPressed: () {}, child: Text("提醒审核")),

      ///商品是窗帘商品 并且处于待审核状态
      visible: controller.order.productType is CurtainProductType &&
          controller.order.orderStatus == OrderStatus.toBeAudited,
    );
  }
}
