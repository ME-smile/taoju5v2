 ...
 * @LastEditTime: 2021-01-15 15:22:57
 */
      ...
      appBar: AppBar(
        ...
        actions: [
          Visibility(
            ...
            child: TextButton(
                onPressed: () =>
                    Get.toNamed(AppRoutes.customerList, arguments: true),
                child: Text("选择已有客户")),
          )
        ],
      ),
        ...
        return SingleChildScrollView(
          child: Form(
            child: Column(
              children: [
                Container(
                  color: XColors.pinnedBannerColor,
                  width: Get.width,
                  ...
                  child: Text(
                    "基本信息",
                    style: TextStyle(
                        fontSize: XDimens.sp26, color: XColors.pinnedTextColor),
                  ),
                ),
                Container(
