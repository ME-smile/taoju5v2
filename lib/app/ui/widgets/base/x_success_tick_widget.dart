...
class XTickSuccessView extends StatefulWidget {
  XTickSuccessView({Key key}) : super(key: key);

  @override
  _XTickSuccessViewState createState() => _XTickSuccessViewState();
}

GlobalKey<_XTickSuccessViewState> tickSuccessViewKey = GlobalKey();

class _XTickSuccessViewState extends State<XTickSuccessView>
