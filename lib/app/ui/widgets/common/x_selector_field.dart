...
import 'package:taojuwu/app/interface/i_xvalue_changable.dart';
...
class XSelectorField<T> extends StatefulWidget {
  ...
  const XSelectorField({
    ...
    this.dividerColor,
    this.style,
    this.trailling = const Icon(XIcons.next),
  }) : super(key: key);
...
class _XSelectorFieldState<T> extends State<XSelectorField<T>> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        // padding:
        //     widget.padding ?? EdgeInsets.symmetric(vertical: XDimens.gap24),
        // margin:
        //     widget.margin ?? EdgeInsets.symmetric(horizontal: XDimens.gap32),
        // decoration: BoxDecoration(
        //     border: Border(
        //         bottom: BorderSide(
        //             color: widget.dividerColor ?? XColors.dividerColor))),
        child: Column(
          children: [
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    widget.hint,
                    // style: widget.hintTextStyle ?? XStyles.inputLabelText,
                  ),
                  Row(
